    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      {formulaResult && mode === "formulas" && (
        <div className="mt-6 space-y-4">
          {/* 1. Formula Detection Report (the neat view — shown first) */}
          <h3 className="text-sm font-semibold text-neutral-700">Formula Detection Report</h3>
          ...
          {/* 2. Rendered output preview */}
          {formulaResult.rendered_html && (
            <div className="rounded-xl border border-neutral-200 bg-white p-4">
              <h3 className="text-sm font-semibold text-neutral-700 mb-3">Rendered Document Preview</h3>
              <div
